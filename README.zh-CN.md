...
| 平衡周期下最快升速 | 周期 `254 tick`，升速 `1.547442 方块/秒`，dy `+19.652515`，水平速度 `22.732565 方块/秒` | `results/fastest-climb-rate` | ![](docs/images/fastest-climb-rate.png) |
...
为了方便直接复用，四个策略的参数文件和逐 tick 时序也镜像到了 `strategies/`：
...
- `scripts/plot_quadrants.py`：从 CSV 结果重新生成四宫格图。
