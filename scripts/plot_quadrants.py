...
def main():
    ...
    plots = [
        ...
        (
            ...
            "fastest-climb-rate",
            "最快升速策略",
            "周期 254 tick，平均升速 1.553 方块/秒",
            "Fastest Climb Strategy",
            "period 254 tick, average climb 1.553 blocks/s",
        ),
        (
            "fastest-horizontal-speed",
            "fastest-horizontal-speed",
            "最快水平速度策略",
            "周期 357 tick，平均水平速度 33.022 方块/秒",
            "Fastest Horizontal Strategy",
            "period 357 tick, average horizontal speed 33.022 blocks/s",
        ),
        (
            "periodic-vx025-no-drop",
            "periodic-vx025-no-drop",
            "平衡周期不掉高的最小高度差",
            "周期 162 tick，高度差 25.561 方块，dy +0.0000000431",
            "Minimum No-Drop Height Span",
            "period 162 tick, height span 25.561 blocks, dy +0.0000000431",
        ),
        (
            "periodic-gain-one",
            "periodic-gain-one",
